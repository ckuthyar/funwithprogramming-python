...
r1=np.hstack((bry9,bry6,bry5))
r2=np.hstack((bry7,bry4,bry8))
r3=np.hstack((bry3,bry2,bry1))

matrixcollage=np.vstack((r1,r2,r3))
cv2.imwrite('matrixcollages2.png',matrixcollage)
